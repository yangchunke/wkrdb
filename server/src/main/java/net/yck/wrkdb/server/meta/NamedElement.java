...
abstract class NamedElement implements Meta {
  ...
  boolean sameName(NamedElement other) {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof NamedElement) {
      return sameName((NamedElement) obj);
    }
  ...
  protected static <O extends NamedElement, T extends NamedElement> O addNamedElementToCollection(O owner,
      Collection<T> elements, T element, OptionOnDuplicate opOnDuplicate) throws IllegalArgumentException {
    ...
    for (T s : elements) {
      if (s.sameName(element)) {
        switch (opOnDuplicate) {
          case IGNORE:
            return owner;
          case UPDATE:
            elements.remove(s);
  ...
  protected static <O extends NamedElement> O addStringToCollection(O owner, Collection<String> collections, String str)
  ...
  protected static <O extends NamedElement, C extends NamedElement> C getNamedElement(O owner, Collection<C> elements,
      String name) {
