...
public class ThriftDbServer extends DbServerBase {
    ...
    private final static ImmutablePair<String, Integer> PROP_DEF_PAIR = new ImmutablePair<String, Integer>(THRIFT_DBSERVER_PORT, 10719);
    ...
    public void run() {
        try {
            ...
            Args args = new Args(serverTransport).maxWorkerThreads(app.config.getProperty(THRIFT_MAX_WORKER_THREADS, DEF_MAX_WORKER_THREADS)).processor(processor);
